...
empiricist_. I think that Hume makes a strong case that we can't derive concepts like
...
non-empiricist, the answer is that there may be concepts, like the self and
causality, that exist _prior_ to any experience we might have. These are precisely
the _a priori_ concepts Kant is concerned with--we will soon turn our attention
